...
class __$$SuccessImplCopyWithImpl<T, $Res>
    extends _$ResultsCopyWithImpl<T, $Res, _$SuccessImpl<T>>
...
abstract class Success<T> implements Results<T> {
...
class __$$FailureImplCopyWithImpl<T, $Res>
    extends _$ResultsCopyWithImpl<T, $Res, _$FailureImpl<T>>
...
class _$FailureImpl<T> implements Failure<T> {
  ...
  @override
  String toString() {
    return 'Results<$T>.failure(message: $message)';
  }
...
abstract class Failure<T> implements Results<T> {
